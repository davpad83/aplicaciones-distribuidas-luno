...
public class EventHandler {
	...
	public void agregarCliente(String nombre, String apellido, String telefono,
			String email, ArrayList<Integer> idsCondicion)
			throws DataEntryException, Exception {
		if ((!nombre.isEmpty() && !apellido.isEmpty())
				|| telefono.length() <= 10)
			clienteRmi.agregarCliente(nombre, apellido, telefono, email, idsCondicion);
		else
			throw new DataEntryException();
	}

	public void modificarCliente(int id, String nombre, String apellido,
			String telefono, String email) throws DataEntryException, Exception {
	...
	public void agregarProveedor(String cuit, String nombre)
			throws DataEntryException, Exception {
		if (!cuit.isEmpty())
	...
	public void eliminarProveedor(int idProveedor, String cuit)
			throws DataEntryException, Exception {
	...
	public void agregarStockRodamiento(String codigo, String marca,
			String origen, String caracteristica, int cantidad)
			throws DataEntryException, Exception {
	...
	public void eliminarStockRodamiento(String codigo, String marca,
			String origen, String caracteristica, int cantidad)
			throws DataEntryException, Exception {
		if (!codigo.isEmpty() && !marca.isEmpty() && !origen.isEmpty()
				&& !caracteristica.isEmpty() && cantidad > 0)
			clienteRmi.eliminarStockRodamiento(codigo, marca, origen,
	...
	public void nuevaCondicionVenta(Float interes, String tipo, int cantDias, float descuento)
			throws DataEntryException, Exception {
		clienteRmi.nuevaCondicionVenta(interes, tipo, cantDias, descuento);
	}

	public ClienteBean getCliente(int idCliente) throws DataEntryException,
			Exception {
		if (idCliente > 0)
